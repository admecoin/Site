...
export const POLYEARN_RABBITS_ADDRESS = '0xDf7952B35f24aCF7fC0487D01c8d5690a60DBa07'

const Nfts: Nft[] = [
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping pen. Especially on BSC.',
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their pen with blueberries. What's your favorite topping?",
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do pen. And these bunnies know it.",
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling syrup, pen, and even lottery tickets! This bunny really loves it.',
